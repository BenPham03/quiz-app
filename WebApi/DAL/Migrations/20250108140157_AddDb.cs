    ...
    public partial class AddDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Interactions_Quizzes_QuizzId",
                        column: x => x.QuizzId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswers", x => new { x.AnswerId, x.QuestionId, x.AttemptId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_QuizzId",
                table: "Interactions",
                column: "QuizzId");

            migrationBuilder.CreateIndex(
                name: "IX_Interactions_UserId_QuizzId",
                table: "Interactions",
                columns: new[] { "UserId", "QuizzId" },
                unique: true,
                filter: "[UserId] IS NOT NULL AND [QuizzId] IS NOT NULL");
